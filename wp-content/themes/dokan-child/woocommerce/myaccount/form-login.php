        ...
        <form method="post" class="login" style="margin:0;">
            ...
            <p class="form-row">
                <label for="rememberme" class="inline container_checkbox">
                    <input name="rememberme" type="checkbox" id="rememberme" value="forever" /><span class="checkmark"></span> <span class="rememberme_text"><?php _e( 'Remember me', 'dokan-theme' ); ?></span>
                </label>
            </p>
