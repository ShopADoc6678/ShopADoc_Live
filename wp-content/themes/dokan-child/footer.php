...
if(($dentist_account_status !='unsubscribe' && $dentist_account_status !='de-active') || strpos($current_url,"/checkout") > 0 || $post->ID == '1735' || $post->ID == '1325' || $post->ID == '342' || $post->ID == '56' || $post->ID == '3850' || $post->ID == '54' || $post->ID == '60'  || $post->ID == '62'  || $post->ID == '66' || $post->ID == '68'){?>
<style type="text/css">
