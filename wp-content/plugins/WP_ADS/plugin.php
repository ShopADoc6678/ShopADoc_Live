              ...
              <div class="containerMain">
				...
				?>
                  <div class="row">
                    ...
                    <div class="col" id="<?php echo $option_name1."_main"?>"> <span id="<?php echo $option_name1;?>_view" class="view_main">
                    ...
                    <div class="col" id="<?php echo $option_name2."_main"?>"> <span id="<?php echo $option_name2;?>_view" class="view_main">
                    ...
                    <div class="col" id="<?php echo $option_name3."_main"?>"> <span id="<?php echo $option_name3;?>_view" class="view_main">
                    ...
                    <div class="col" id="<?php echo $option_name4."_main"?>"> <span id="<?php echo $option_name4;?>_view" class="view_main">
...
function load_image(id,ext){
	...
	function AdPopup(id,type,selected_ad){
	 ...
	 jQuery.ajax({	
				url:'<?php echo get_site_url();?>/ajax.php',	
				type:'POST',
				data:{'mode':'getAddADPopup','ad_id':ad_id,'type':type,'selected_ad':selected_ad},
				beforeSend: function() {},
				complete: function() {
				},
				success:function (data){
