						...
						if ( $customer_user ) {
							...
							if(is_array($customer_user)){
								...
								foreach ($customer_user as $key => $user) {
									...
									$html_winner = '<img src="'.get_site_url().'/wp-content/themes/dokan-child/Winner-Dentist.gif" border="0" alt="" title="Winner-Dentist">';
									$html_congratulations = '<img src="'.get_site_url().'/wp-content/themes/dokan-child/Congratulations-Client.gif" border="0" alt="" title="Congratulations-Client">';
									...
									$author_email = get_the_author_meta( 'user_email',$product_data->post->post_author );
