	...
	class WooCommerceMusicPlayer
	{
		...
		*/
		...
		public function enqueue_resources()
		{
			...
			wp_enqueue_script('wcmp-script', plugin_dir_url(__FILE__).'js/public.js', array('jquery', 'wp-mediaelement'), '1.0.172');
		...
		private function _is_local( $url )
		{
            ...
            else
            {
                ...
                if( $attachment_id )
                {
                    ...
                    if( $attachment_path && file_exists( $attachment_path ) ) $file_path = $attachment_path;
                }
            }
